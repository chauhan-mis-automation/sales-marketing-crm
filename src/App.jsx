  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/sales-marketing/unassigned" element={<SMProtectedRoute smUser={smUser} title="Unassigned"><SMUnassignedContacts /></SMProtectedRoute>} />
        <Route path="/sales-marketing/projects" element={<SMProtectedRoute smUser={smUser} title="All Projects"><SMAllProjects /></SMProtectedRoute>} />
        <Route path="/sales-marketing/calendar" element={<SMProtectedRoute smUser={smUser} title="Calendar"><CalendarPage key={smRefreshKey} currentUser={{ name: smUser?.name, userID: smUser?.userId }} isAdmin={smUser?.role === 'Admin'} onUpdateFollowUp={setActiveFollowUp} /></SMProtectedRoute>} />
